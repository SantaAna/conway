defmodule ConwayWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ConwayWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ConwayWeb.Gettext, "errors", msg, opts)
    end
  end
